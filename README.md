# Pokemon Snap Archipelago World

Original forked from [ArsonAssassin's PSAP World](https://github.com/ArsonAssassin/PSAP).

Note: To use this repository, you must already have a legally acquired English ROM for Pokemon Snap (sha1: `edc7c49cc568c045fe48be0d18011c30f393cbaf`). It is **NOT** provided for you as part of this repository.

## Setup

See [Setup Instructions](apworld/pokemon_snap/docs/setup_en.md).
