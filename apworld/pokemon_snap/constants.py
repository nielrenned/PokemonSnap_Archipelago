...
ADAPTER_SCRIPT_NAME: str = "ap_psnap_pj64_adapter.js"
...
CONNECTING_STATUS: str = "Successfully connected to Project64, awaiting connection to server..."
CONNECTED_STATUS: str = "Verified current rom as Pokemon Snap, ready to play AP!"